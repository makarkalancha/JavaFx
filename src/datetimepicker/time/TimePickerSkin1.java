...
public class TimePickerSkin1  extends ComboBoxPopupControl<LocalTime> {
    ...
    public TimePickerSkin1(TimePicker1 timePicker) {
        ...
        this.editorNode = new TextField1();
        ...
        ((SVGGlyph1)this.arrow).fillProperty().bind(timePicker.defaultColorProperty());
        ((SVGGlyph1)this.arrow).setSize(20.0D, 20.0D);
    ...
    protected Node getPopupContent() {
        if(this.content == null) {
            this.content = new TimePickerContent1(this.jfxTimePicker);
        }
    ...
    public void show() {
        ...
        if(this.jfxTimePicker.isOverLay() && this.dialog == null) {
            ...
            this.dialog = new Dialog1(dialogParent, (Region)this.getPopupContent(), Dialog1.DialogTransition.CENTER, true);
