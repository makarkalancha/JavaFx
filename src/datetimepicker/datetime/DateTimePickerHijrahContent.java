 ...
 * Time: 11:19
 */
public class DateTimePickerHijrahContent extends DateTimePickerContent{
    private Label hijrahMonthYearLabel;

    DateTimePickerHijrahContent(final DateTimePicker dateTimePicker) {
    ...
    @Override protected void updateMonthYearPane() {
        ...
        for (DateCell dayCell : dayCells) {
            LocalDate date = dayCellDate(dayCell).toLocalDate();
